...
After generating the website, you MUST save each file separately using the save_website_file tool.
Call save_website_file once for each file with the exact filename and complete content.
"""
